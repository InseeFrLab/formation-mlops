...
3. In the UI, look at the results of your previous run:
    + `Experiments -> fasttext -> <run_name>`
4. You have trained the model with some default parameters. In `MLproject` check the parameters available. Re-train a model with different parameters (e.g. `dim = 25`).

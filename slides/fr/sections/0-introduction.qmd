...
- Tirer parti des [**meilleures pratiques**]{.orange} en génie logiciel
  ...
  - [**Déployer**]{.blue2} des applications de manière [**extensible**]{.blue2}
...
- Avantages de `MLflow` : 
  ...
  - [**Agnostic**]{.blue2} au package ML utilisé
  - Nous avons de l'[**expérience**]{.blue2} avec lui
...
- Un environnement [**d'innovation ouvert**]{.orange}
  ...
  - De grandes [**ressources**]{.blue2} de calcul (y compris des GPU)

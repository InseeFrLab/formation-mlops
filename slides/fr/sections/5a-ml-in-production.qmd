...
➡️ [**Communication**]{.orange} indispensable entre les équipes pour [**contrôler**]{.orange} le modèle en production
...
- Ajout de [**logs**]{.orange} dans l'API pour enregistrer les évènements de celle-ci

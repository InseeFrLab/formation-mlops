...
- Performance en [**temps réel**]{.orange} du modèle souvent impossible, utilisation de proxys :
    - [**données d'entrées**]{.blue2} (distributions des variables, analyse des données manquantes...)
    - [**prédictions**]{.blue2} du modèle (distributions et statistiques descriptives des valeurs prédites)
:::

...
3. Exécutez un entraînement du modèle à l'aide de MLflow. Pour ce faire, ouvrez un terminal ({{< bi bi-list >}} `-> Terminal -> New Terminal`) et exécutez la commande suivante :
...
4. Créez un script `predict.py` dans le dossier `src` du projet. Ce script doit : 

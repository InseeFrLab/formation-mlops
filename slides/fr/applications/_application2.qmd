...
:::{.nonincremental}
:::: {.callout-tip collapse="true" icon=false}
## Partie 2 : Entraînement d'un modèle personnalisé
...
3. Dans `MLflow`, enregistrez votre dernier modèle en tant que `fasttext` pour le rendre facilement interrogeable depuis `Python`.

...
- Schéma de Romain sur le dev -> dockerfile -> docker image -> dockerhub... ??
...
- [**Argo CD**]{.orange}:
    - [**Deployment tool**]{.blue2} used to streamline and automate the deployment process.
    - [**Simplifies**]{.blue2} managing application deployments (e.g. rollbacks and updates).